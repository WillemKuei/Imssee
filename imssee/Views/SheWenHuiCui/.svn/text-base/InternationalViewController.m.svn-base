...
#import "HSList.h"
@interface InternationalViewController ()<UITableViewDataSource,UITableViewDelegate>
{
    int _page;
}
...
{
    NSDictionary *params = @{@"pageNo":[NSNumber numberWithInt:_page]};
    [WGProgressHUD showHUDAddedTo:self.view status:@"请稍后"];
    __weak InternationalViewController *blockSelf = self;
