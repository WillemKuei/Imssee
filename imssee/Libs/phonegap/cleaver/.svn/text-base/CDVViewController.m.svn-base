...
//    if (iPhone5)
//    {          /////  ios7适配 mzq
//        webViewBounds = CGRectMake(0, 44, self.view.bounds.size.width, self.view.bounds.size.height - 44);//Y44 ——》20  edit by dujw
//    }
//    else
//    {
//        webViewBounds = CGRectMake(0, 44, self.view.bounds.size.width, self.view.bounds.size.height - 44);//Y44 ——》20  edit by dujw
//    }
    ...
    webViewBounds = CGRectMake(0, 44, self.view.bounds.size.width, self.view.bounds.size.height - 44);
